...
<body>
  ...
  <%@ page import="javax.swing.*" %>  
 	...
 	<form action="<%=url.controlador%>controladorpassword.jsp" method="post">
		...
		<input type="password" name="oldpass" id="oldpass" placeholder="Introduce Contraseña actual" required>
	...
	<br>
		...
		<input type="password" name="newpass" id="newpass" placeholder="Introduce Contraseña nueva" required>
	...
	<br>
		...
		<input type="password" name="reppass" id="reppass" placeholder="Introduce Contraseña nueva repetida" required>
